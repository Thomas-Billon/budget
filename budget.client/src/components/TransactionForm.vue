<script setup lang="ts">
    ...
    const formatAmount = (value: string): string => {
        ...
        return value ? decimalValue.toLocaleString(undefined, { minimumFractionDigits: 2 }) : '';
    }
        ...
        <div class="page-container">
            ...
            <div class="grow flex flex-col justify-center gap-6 transition-opacity" :class="[ model.type === TransactionType.None ? 'opacity-0' : '' ]">
                ...
                <div class="flex items-stretch gap-4 h-24">
                    <input class="input text-6xl font-light text-center" type="text" id="transaction-amount" name="Amount" v-model="model.amount" :placeholder="amountPlaceholder" autocomplete="off" @change="onAmountChange($event)" required />
